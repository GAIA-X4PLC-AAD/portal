...
const StepsPane = ({ type, currentStage }) => {
  ...
  return (
    <>
      ...
      {buildStepCardView({
        stage: '5',
        title: t('onboarding.proof_on_onboarding'),
        subtitle: t('onboarding.step_5'),
        isActive: currentStage === 5
      })}
      {buildStepCardView({
        stage: '6',
        title: t('onboarding.vc_details'),
        subtitle: t('onboarding.step_6'),
        isActive: currentStage === 6
      })}
      {buildStepCardView({
        stage: '7',
        title: t('onboarding.finish_onboarding'),
        subtitle: t('onboarding.step_7'),
