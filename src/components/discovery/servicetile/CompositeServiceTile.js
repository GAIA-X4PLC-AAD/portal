...
import ScreenshotsTab from "../tabs/screenshots/ScreenshotsTab.js";
        ...
        return (
            <>
                <ExpandableView
                    ...
                    borderBottom={false}
                    width={_width} />
                <ExpandableView hidden={true} initiallyExpanded={false} view={PriceTab({ id: id, type: 'services' })} title={<>{padTitle({ _titleView: <>{t("service-tile.price")}</> })}</>}  titleTrailerPadding="12px" viewLeadingPadding="40px" titleLeadingPadding="40px" arrowColor="#B3B3B3" width={_width} shiftedBottomBorder={true} borderBottom={false}/>
                ...
                <ExpandableView initiallyExpanded={false} view={ContactTab({ id: id, type: 'services' })} title={<>{padTitle({ _titleView: <>{t("service-tile.contact")}</> })}</>}  titleTrailerPadding="12px" viewLeadingPadding="40px" titleLeadingPadding="40px" arrowColor="#B3B3B3" width={_width} maxWidth1='850px' shiftedBottomBorder={false} borderBottom={false}/>
            </>
        )
    }
