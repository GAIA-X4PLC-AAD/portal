...
export default function createTextSparks(){
...
class TextSparks {
    constructor() {
        ...
        this.engine = this.canvas.getContext("2d", { willReadFrequently: true });
