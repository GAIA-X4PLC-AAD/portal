...
const Routes: FC = () => (
  <Column>
    <ReactRoutes>
      ...
      <Route path="/resources/details/*" element={ViewContainer(<ProtectedRoute><ResourcesDetailsPage /></ProtectedRoute>)} />      <Route path="/services" element={ViewContainer(<SearchView type="services" />)} />
