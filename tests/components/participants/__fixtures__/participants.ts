import {Participant, ParticipantDetail} from '../../../../src/types/participants.model';


export const mockParticipant_msg_systems_ag: ParticipantDetail = {
...
export const mockParticipant_tracetronic_GmbH: ParticipantDetail = {
...
export const mockParticipant_bmw_ag: ParticipantDetail = {
  legalName: 'BMW AG',
  claimsGraphUri: [
...
export const mockParticipant_Infineon_Technologies_AG: ParticipantDetail = {
